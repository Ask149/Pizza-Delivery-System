...
$(".a").on("click",{d:1},function(){
  //alert("1");
  var url = 'list.html?name=' + 1;
  window.location.href = url;
});
$(".b").on("click",{d:2},function(){
  var url = 'list.html?name=' + 2;
  window.location.href = url;
});
$(".c").on("click",{d:3},function(){
  var url = 'localhost/WTL/list.html?name=' + 3;
  window.location.href = url;
});
$(".d").on("click",{d:4},function(){
  var url = 'localhost/WTL/list.html?name=' + 4;
  window.location.href = url;
});
$(".e").on("click",{d:5},function(){
  var url = 'localhost/WTL/list.html?name=' + 5;
  window.location.href = url;
});
$(".f").on("click",{d:6},function(){
  var url = 'localhost/WTL/list.html?name=' + 6;
  window.location.href = url;
});